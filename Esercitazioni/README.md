...
### 81 - File: legge un file.txt e sorteggia un nome random e lo salva in un altro file (controlla se esiste):
<details>
    <summary> codice </summary>
...
### 82 - File: legge un file.txt e sorteggia un nome random e lo salva in un altro file (controlla se esiste e se è presente il nome):
<details>
    <summary> codice </summary>
